...
class paypal_class {
   ...
   function submit_paypal_post() {
      ...
      echo "<html>\n";
      echo "<head><title>".JText::_("Processing Payment")."...</title></head>\n";
//echo "<body>";
      echo "<body onLoad=\"document.forms['paypal_form'].submit();\">\n";
      echo "<center><h2>";
      echo JText::_("Please wait, your order is being processed and you will be redirected to the paypal website.");
      echo "</h2></center>\n";
      ...
      echo "<center><br/><br/>";
      echo JText::_('If you are not automatically redirected to paypal within 5 seconds')."...";
      echo "<br/><br/>\n";
      echo '<input type="submit" value="'.JText::_("Click Here").'"></center>'."\n";
